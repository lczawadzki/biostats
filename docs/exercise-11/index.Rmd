...
"P > 0.05, therefore our results are __NOT__ statistically significant, and we __fail to reject__ the H0. Our data meet our null expectations, and are due to chance. We conclude that there is no difference in time to mating between starved and fed females; i.e. the shape of each distribution is the same."  
...
t.test(bumpus$weight_g~bumpus$survival, data = bumpus, var.equal = F)
#p = 0.01321
...
swimdif <- swimmers$Infections.after-swimmers$Infections.before
...
binom.test(x = 2, n = 14, p = 0.5)
#p = 0.01294
#p < 0.05, reject H0. We can conclude that the medication works to decrease ear infections in swimmers.
