...
5a. Read the file into _R_ from the GitHub using the following URL: https://github.com/lczawadzki/biostats/raw/main/data/MandMlist.csv.
...
So, from our output, we know that our ___P___ __-value = 0.3985__.  
...
3. Our ___P-value___ with the correct df, equals __0.737532__.
...
chisq.test(obs)
#p < 0.05, reject H0;
#the number of birthdays is NOT the same on every day of the week.
    ```