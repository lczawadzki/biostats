...
3. __lower.tail = F__ - specifies a one-taile test  
...
2. Our __X-squared test statisic equals 5.1442__, our __df (degrees of freedom) equals 5__, and our ___P___ __-value = 0.3985__.  
...
```{r echo = T}
     ...
     obs
```
d. Next, we find our mean expected frequency (µ or lambda). Even though we have frequency data, since each observation is listed in a single column, __mean()__ will calculate the mean correctly.
```{r echo = T, results = 'hide'}
